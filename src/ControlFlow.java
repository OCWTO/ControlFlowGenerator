...
public class ControlFlow
{
	 ...
	 */
	public ControlFlow(File srcFolder, File inputFile) throws Exception
	{
		...
		getCFG(GetBasicBlocks(mainMethod));
	...
	private void getCFG(List<BasicBlock> methodBlocks)
	{
		...
		//graphEdges.add(new Edge(entryBlock, methodBlocks.get(1)));
